...
public class MessageController {
    ...
    public ResponseEntity<List<MesssageResponse>> getMessages(@PathVariable("chat-id") String chatId){
        return ResponseEntity.ok(messageService.findChetMessages(chatId));
